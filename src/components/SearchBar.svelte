...
{#if modalOpen}
  <div class="fixed inset-0 z-50 flex items-start justify-center pt-16 px-4">
    <div
      class="relative w-full max-w-4xl bg-white rounded-xl shadow-2xl border border-gray-200 max-h-[80vh] flex flex-col"
    >
                ...
                >
                  ...
                  >
                    <div class="flex-1 min-w-0">
                      <h3
                        class="font-semibold text-gray-900 group-hover:text-blue-700 truncate text-lg"
                      >
                        {entity.title}
                      </h3>
